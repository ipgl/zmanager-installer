...
if command -v curl >/dev/null 2>&1; then
    curl -sL -o zmanager_installer.tar.gz https://raw.githubusercontent.com/ipgl/zmanager-installer/main/zmanager_installer.tar.gz
elif command -v wget >/dev/null 2>&1; then
    wget -q -O zmanager_installer.tar.gz https://raw.githubusercontent.com/ipgl/zmanager-installer/main/zmanager_installer.tar.gz
else
